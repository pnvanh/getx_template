  ...
  void onError(DioException exception, ErrorInterceptorHandler handler) {
    if (error) {
      if (exception.type == DioExceptionType.badResponse) {
        ...
        _printBoxed(
            header:
                'DioError ║ Status: ${exception.response?.statusCode} ${exception.response?.statusMessage}',
            text: uri.toString());
        if (exception.response != null && exception.response?.data != null) {
          logPrint('╔ ${exception.type.toString()}');
        ...
        _printBoxed(
            header: 'DioError ║ ${exception.type}', text: exception.message);
      }
    }
